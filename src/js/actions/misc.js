...
import {MISC_CONSTANTS as m, USER_CONSTANTS as u, CATEGORY_CONSTANTS as c,SECTION_CONSTANTS as sec, SUPPLIER_CONSTANTS as sup,NAV_ACTIVATE} from  '../utils/constants';
...
export function initialize () {
  ...
  return function (dispatch) {
    ...
    .then(axios.spread(function (categories, sections,suppliers, users) {
